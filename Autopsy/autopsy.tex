...
% Manually set the font size to 17pt
% \makeatletter
% \renewcommand\normalsize{%
%    \@setfontsize\normalsize\@xviipt{20}%
%    \abovedisplayskip 16\p@ \@plus8\p@ \@minus4\p@
...
\begin{center}
    \includegraphics[width=0.95\textwidth]{newCaseInfo.PNG}
\end{center}
...
\begin{center}
    \includegraphics[width=0.95\textwidth]{additionalInfo.PNG}
\end{center}
...
\begin{center}
    \includegraphics[width=0.95\textwidth]{addDataSource.PNG}
\end{center}
...
\begin{center}
    \includegraphics[width=0.95\textwidth]{selectDataSourceType.PNG}
\end{center}

Next we will be prompted to select the data source file. 

\begin{center}
    \includegraphics[width=0.95\textwidth]{selectDataSourceFile.PNG}
\end{center}

After selecting the data source file, we will be prompted to configure the Ingest Modules:

\begin{center}
    \includegraphics[width=0.95\textwidth]{configureIngestModule.PNG}
\end{center}
...
\begin{minipage}{0.45\textwidth}
  \centering
  \begin{center}
    \includegraphics[width=0.95\textwidth]{3/3.1/Screenshot 2024-02-27 at 8.15.21 PM.png}
...
\begin{center}
    \includegraphics[width=0.95\textwidth]{GPX Parser.png}
\end{center}
